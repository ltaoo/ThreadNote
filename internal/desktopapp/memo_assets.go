...
func extractMemoLocations(content string) []string {
	searchText := memoSearchableMarkdown(content)
	matches := memoLocationPattern.FindAllStringSubmatch(searchText, -1)
...
func parseMemoAssetReference(value string) (memoAssetReference, bool) {
	...
	// Strip query parameters (e.g. "@assets/default/img.jpg?w=800&h=600")
