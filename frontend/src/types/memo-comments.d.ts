...
export declare function createMemoCommentInVault(memoId: MemoID | string, content: string, visibility?: string, isPrivate?: boolean, replyTo?: string): Promise<MemoCommentRecord>;
